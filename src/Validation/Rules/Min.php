...
/**
 * Written in a rule list as `min:18`, where the number is the smallest a number may be, or the shortest a string.
 */
class Min implements RuleInterface
{
    ...
    public function message(string $field): string
    {
        ...
        return "The {$field} field has to be at least {$limit}";
    }
}
